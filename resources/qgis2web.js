...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-380316.458047, 818630.720103, -303036.007317, 885423.640946], maxZoom: 28, minZoom: 1
    })
});


map.getView().fit([-380316.458047, 818630.720103, -303036.007317, 885423.640946], map.getSize());
